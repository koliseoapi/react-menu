...
var _resolvePathname = _interopRequireDefault(__webpack_require__(43));

var _valueEqual = _interopRequireDefault(__webpack_require__(44));
...
var baseCreate = __webpack_require__(31),
...
var _Router = _interopRequireDefault(__webpack_require__(23));
...
var _pathToRegexp = _interopRequireDefault(__webpack_require__(91));
...
var _BrowserRouter2 = _interopRequireDefault(__webpack_require__(81));

var _HashRouter2 = _interopRequireDefault(__webpack_require__(85));

var _Link2 = _interopRequireDefault(__webpack_require__(46));

var _MemoryRouter2 = _interopRequireDefault(__webpack_require__(87));

var _NavLink2 = _interopRequireDefault(__webpack_require__(90));

var _Prompt2 = _interopRequireDefault(__webpack_require__(93));

var _Redirect2 = _interopRequireDefault(__webpack_require__(95));

var _Route2 = _interopRequireDefault(__webpack_require__(47));

var _Router2 = _interopRequireDefault(__webpack_require__(22));

var _StaticRouter2 = _interopRequireDefault(__webpack_require__(101));

var _Switch2 = _interopRequireDefault(__webpack_require__(103));

var _matchPath2 = _interopRequireDefault(__webpack_require__(105));

var _withRouter2 = _interopRequireDefault(__webpack_require__(106));
...
var _Route = _interopRequireDefault(__webpack_require__(48));
...
var _matchPath = _interopRequireDefault(__webpack_require__(24));
...
var identity = __webpack_require__(28),
    metaMap = __webpack_require__(58);
/**
...
var composeArgs = __webpack_require__(60),
    composeArgsRight = __webpack_require__(61),
    countHolders = __webpack_require__(132),
    createCtor = __webpack_require__(16),
    createRecurry = __webpack_require__(62),
    getHolder = __webpack_require__(34),
    reorder = __webpack_require__(147),
...
var isLaziable = __webpack_require__(133),
...
var metaMap = __webpack_require__(58),
    noop = __webpack_require__(134);
/**
...
var baseSetData = __webpack_require__(57),
    shortOut = __webpack_require__(56);
/**
...
var getWrapDetails = __webpack_require__(139),
    insertWrapDetails = __webpack_require__(140),
    setToString = __webpack_require__(30),
    updateWrapDetails = __webpack_require__(141);
/**
...
let createDummyComponent = function (label, index) {
  return function () {
    ...
    // Internet is awesome
    var corpus = ['Vanilla (╯°□°)╯︵ ┻━┻', 'Half way there ┬─┬﻿ ノ( ゜-゜ノ)', 'Pudgy (ノ ゜Д゜)ノ ︵ ┻━┻', 'In soviet Russia ┬─┬﻿ ︵ /(.□. \）', 'Emotional (ﾉಥ益ಥ）ﾉ﻿ ┻━┻', 'Magical (/¯◡ ‿ ◡)/¯ ~ ┻━┻'];
    return _react.default.createElement("div", {
      className: "test-selected-contents"
    }, _react.default.createElement("h1", null, label), _react.default.createElement("p", null, corpus[index % corpus.length]));
  };
};

function MyAppComponent(props) {
  return _react.default.createElement("div", null, _react.default.createElement(_main.Menu, null, _react.default.createElement(_main.MenuItem, {
    className: "menu-item",
    to: "events"
  }, "Events"), _react.default.createElement(_main.MenuItem, {
    className: "menu-item",
    to: "books"
  }, "Books"), _react.default.createElement(_main.MenuItem, {
    className: "menu-item",
    to: "theater"
  }, "Theater"), _react.default.createElement(_main.MenuItem, {
    className: "menu-item",
    to: "music"
  }, "Music"), _react.default.createElement(_main.MenuItem, {
    className: "menu-item",
    to: "base"
  }, "BASE jump"), _react.default.createElement(_main.MenuItem, {
    className: "menu-item",
    to: "chess"
  }, "Chess"), _react.default.createElement(_main.MenuItem, {
    className: "menu-item",
    to: "go"
  }, "Go"), _react.default.createElement(_main.MenuItem, {
    className: "menu-item",
    to: "cars"
  }, "Cars")), props.children);
}
...
function Router() {
  return _react.default.createElement(_reactRouterDom.HashRouter, null, _react.default.createElement(MyAppComponent, null, _react.default.createElement(_reactRouterDom.Route, {
    path: "/events",
    component: createDummyComponent('events', 0)
  }), _react.default.createElement(_reactRouterDom.Route, {
    path: "/books",
    component: createDummyComponent('Books', 1)
  }), _react.default.createElement(_reactRouterDom.Route, {
    path: "/theater",
    component: createDummyComponent('theater', 2)
  }), _react.default.createElement(_reactRouterDom.Route, {
    path: "/music",
    component: createDummyComponent('music', 3)
  }), _react.default.createElement(_reactRouterDom.Route, {
    path: "/base",
    component: createDummyComponent('BASE', 4)
  }), _react.default.createElement(_reactRouterDom.Route, {
    path: "/chess",
    component: createDummyComponent('chess', 5)
  }), _react.default.createElement(_reactRouterDom.Route, {
    path: "/go",
    component: createDummyComponent('go', 6)
  }), _react.default.createElement(_reactRouterDom.Route, {
    path: "/cars",
    component: createDummyComponent('cars', 7)
...
_reactDom.default.render(_react.default.createElement(Router, null), document.getElementsByClassName('test-container1')[0]);

_reactDom.default.render(_react.default.createElement(Router, null), document.getElementsByClassName('test-container2')[0]);
...
var _throttle = _interopRequireDefault(__webpack_require__(109));

var _bindAll = _interopRequireDefault(__webpack_require__(116));
...
class KebabMenu extends _react.default.Component {
  constructor(props) {
    super(props);
    this.state = {
    ...
    (0, _bindAll.default)(this, ['bodyClick', 'switchPopupVisible']);
  }
  ...
  render() {
    ...
    return _react.default.createElement("div", {
      ...
      className: "kebab-menu-button-dot"
    }), _react.default.createElement("span", {
      className: "kebab-menu-button-dot"
    }), _react.default.createElement("span", {
      className: "kebab-menu-button-dot"
...
class Menu extends _react.default.Component {
  constructor(props) {
    ...
    (0, _bindAll.default)(this, ['getMenuContainerWidth', 'onResize']);
  ...
  componentDidMount() {
    ...
    if (!elementWidths) {
      ...
      const domNode = _reactDom.default.findDOMNode(this); // width where we should make the menu fit
  ...
  getMenuContainerWidth() {
    let width = _reactDom.default.findDOMNode(this).parentElement.offsetWidth;

    const kebabRef = this.refs.kebabMenu;
    return width - (!kebabRef ? 0 : _reactDom.default.findDOMNode(kebabRef).offsetWidth);
  }
  ...
  onResize() {
    const setContainerWidth = (0, _throttle.default)(() => {
      this.setState({
  ...
  render() {
    ...
    const {
      ...
      className,
      popupClassName
    } = this.props; // menu items to be displayed on the left

    let menuItems = []; // menu items to be collapsed on the right

    let kebabMenuItems = [];

    if (elementWidths) {
      // accumulated widths of menu items displayed on the left
      let accWidth = 0; // identify all items that may fit

      _react.default.Children.map(children, function (element, index) {
        // if it's not a string
        if (_react.default.isValidElement(element)) {
          const copy = _react.default.cloneElement(element, {
            key: '__' + index
          });
    ...
    return _react.default.createElement("nav", {
      ref: "menu",
      className: (className || "responsive-menu") + (!this.state.elementWidths ? ' hidden' : '')
    }, menuItems, _react.default.createElement(KebabMenu, {
      ref: "kebabMenu",
      className: popupClassName || 'kebab-menu'
    }, kebabMenuItems));
  }
...
if (process.env.NODE_ENV !== "production") {
  (function () {
    ...
    var checkPropTypes = __webpack_require__(18); // TODO: this is special because it gets imported during build.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */if(process.env.NODE_ENV!=="production"){(function(){'use strict';var React=__webpack_require__(0);var invariant=__webpack_require__(9);var warning=__webpack_require__(13);var ExecutionEnvironment=__webpack_require__(36);var _assign=__webpack_require__(8);var emptyFunction=__webpack_require__(5);var EventListener=__webpack_require__(37);var getActiveElement=__webpack_require__(38);var shallowEqual=__webpack_require__(39);var containsNode=__webpack_require__(40);var focusNode=__webpack_require__(41);var emptyObject=__webpack_require__(12);var checkPropTypes=__webpack_require__(18);var hyphenateStyleName=__webpack_require__(77);var camelizeStyleName=__webpack_require__(79);/**
 * WARNING: DO NOT manually require this module.
 * This is a replacement for `invariant(...)` used by the error code system
 * and will _only_ be required by the corresponding babel pass.
 * It always throws.
...
var _createBrowserHistory = _interopRequireDefault(__webpack_require__(84));

var _Router = _interopRequireDefault(__webpack_require__(22));
...
var _createHashHistory = _interopRequireDefault(__webpack_require__(86));
...
var _MemoryRouter = _interopRequireDefault(__webpack_require__(88));
...
var _createMemoryHistory = _interopRequireDefault(__webpack_require__(89));
...
var _Route = _interopRequireDefault(__webpack_require__(47));

var _Link = _interopRequireDefault(__webpack_require__(46));
...
var _Prompt = _interopRequireDefault(__webpack_require__(94));
...
var _Redirect = _interopRequireDefault(__webpack_require__(96));
...
var _createBrowserHistory2 = _interopRequireDefault(__webpack_require__(98));

var _createHashHistory2 = _interopRequireDefault(__webpack_require__(99));

var _createMemoryHistory2 = _interopRequireDefault(__webpack_require__(100));
...
var _createTransitionManager = _interopRequireDefault(__webpack_require__(25));
...
var _StaticRouter = _interopRequireDefault(__webpack_require__(102));
...
var _Switch = _interopRequireDefault(__webpack_require__(104));
...
var _withRouter = _interopRequireDefault(__webpack_require__(107));
...
var _hoistNonReactStatics = _interopRequireDefault(__webpack_require__(108));
...
var baseRest = __webpack_require__(125),
    createWrap = __webpack_require__(128),
    getHolder = __webpack_require__(34),
    replaceHolders = __webpack_require__(17);
/** Used to compose bitmasks for function metadata. */
...
var baseSetData = __webpack_require__(57),
    createBind = __webpack_require__(130),
    createCurry = __webpack_require__(131),
    createHybrid = __webpack_require__(59),
    createPartial = __webpack_require__(149),
    getData = __webpack_require__(63),
    mergeData = __webpack_require__(150),
    setData = __webpack_require__(67),
    setWrapToString = __webpack_require__(68),
...
var LazyWrapper = __webpack_require__(32),
    getData = __webpack_require__(63),
    getFuncName = __webpack_require__(135),
    lodash = __webpack_require__(137);
/**
...
var realNames = __webpack_require__(136);
/** Used for built-in method references. */
...
var LazyWrapper = __webpack_require__(32),
    ...
    isObjectLike = __webpack_require__(15),
    wrapperClone = __webpack_require__(138);
/** Used for built-in method references. */
...
var flatten = __webpack_require__(154),
    overRest = __webpack_require__(55),
    setToString = __webpack_require__(30);
/**
